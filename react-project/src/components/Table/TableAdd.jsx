...
export default function BasicTable() {
  ...
  todayago.setDate(today.getDate() - 29);
  ...
  let drinkdetail = (
    <span>
      <span style={{ color: 'blue', fontWeight: 'bold' }}>30일</span>간 마신 음주량은
      <span style={{ color: 'red', fontWeight: 'bold' }}> {CardsData[0].valueAdd}</span> 입니다.
      <span style={{ color: 'blue', fontWeight: 'bold' }}> 30일</span> 설정 음주량
      <span style={{ color: 'red', fontWeight: 'bold' }}> {Math.ceil(Userinfo[0].u_maxalcohol / (360 * 7) * 30 * 100) / 100}병</span> 에 비해
    </span>
  );
  let drinkdetailadd
  let drinktime;
  let drinktimedetail = (
    <span>
      <span style={{ color: 'blue', fontWeight: 'bold' }}>30일</span>간 마신 음주시간은
      <span style={{ color: 'red', fontWeight: 'bold' }}> {Math.ceil(CardsData[1].valueAdd.replace('h', '') * 100) / 100}h</span> 입니다.
      <span style={{ color: 'blue', fontWeight: 'bold' }}> 30일</span> 설정 음주시간
      <span style={{ color: 'red', fontWeight: 'bold' }}> {Math.ceil(Userinfo[0].u_maxtime / (60 * 7) * 30 * 100) / 100}h</span> 에 비해
    </span>
  );
  ...
  let drinkspeeddetail = (
    <span>
      <span style={{ color: 'blue', fontWeight: 'bold' }}>30일</span>간 마신 하루 평균 음주속도는
      <span style={{ color: 'red', fontWeight: 'bold' }}> {CardsData[2].valueAdd}</span> 입니다.
      <span style={{ color: 'blue', fontWeight: 'bold' }}> 30일</span> 설정 평균 음주속도
  ...
  if (CardsData[0].barValueAdd <= 80) {
    drink = "양호"
    drinkdetailadd = (
      <span>
        <span style={{ color: '#43aa8b', fontWeight: 'bold' }}> {Math.ceil(CardsData[0].barValueAdd * 100) / 100}%</span>로
  ...
  } else if (CardsData[0].barValueAdd < 100) {
    drink = "주의"
    drinkdetailadd = (
      <span>
        <span style={{ color: '#f9c74f', fontWeight: 'bold' }}> {Math.ceil(CardsData[0].barValueAdd * 100) / 100}%</span>로
    ...
    drinkdetailadd = (
      <span>
        <span style={{ color: '#f94144', fontWeight: 'bold' }}> {Math.ceil(CardsData[0].barValueAdd * 100) / 100}%</span>로
  ...
  if (CardsData[1].barValueAdd <= 80) {
    drinktime = "양호"
    drinktimedetailadd = (
      <span>
        <span style={{ color: '#43aa8b', fontWeight: 'bold' }}> {Math.ceil(CardsData[1].barValueAdd * 100) / 100}%</span>로
        설정 음주시간의 <span style={{ color: '#43aa8b', fontWeight: 'bold' }}> 80% 이하</span> 입니다.
        <br />
        <span style={{ color: '#43aa8b', fontWeight: 'bold', fontSize: '15px' }}> 양호합니다.</span>
      </span>
    )
  } else if (CardsData[1].barValueAdd < 100) {
    drinktime = "주의"
    drinktimedetailadd = (
      <span>
        <span style={{ color: '#f9c74f', fontWeight: 'bold' }}> {Math.ceil(CardsData[1].barValueAdd * 100) / 100}%</span>로
    ...
    drinktimedetailadd = (
      <span>
        <span style={{ color: '#f94144', fontWeight: 'bold' }}> {Math.ceil(CardsData[1].barValueAdd * 100) / 100}%</span>로
  ...
  if (CardsData[2].barValueAdd <= 80) {
    drinkspeed = "양호"
    drinkspeeddetailadd = (
      <span>
        <span style={{ color: '#43aa8b', fontWeight: 'bold' }}> {Math.ceil(CardsData[2].barValueAdd * 100) / 100}%</span>로
        설정 음주속도의 <span style={{ color: '#43aa8b', fontWeight: 'bold' }}> 80% 이하</span> 입니다.
        <br />
        <span style={{ color: '#43aa8b', fontWeight: 'bold', fontSize: '15px' }}> 양호합니다.</span>
      </span>
    )
  } else if (CardsData[2].barValueAdd < 100) {
    drinkspeed = "주의"
    drinkspeeddetailadd = (
      <span>
        <span style={{ color: '#f9c74f', fontWeight: 'bold' }}> {Math.ceil(CardsData[2].barValueAdd * 100) / 100}%</span>로
    ...
    drinkspeeddetailadd = (
      <span>
        <span style={{ color: '#f94144', fontWeight: 'bold' }}> {Math.ceil(CardsData[2].barValueAdd * 100) / 100}%</span>로
